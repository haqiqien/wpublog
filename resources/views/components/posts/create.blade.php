<div class="relative p-4 bg-white rounded-lg border dark:bg-gray-800 sm:p-5">
    ...
    <form action="/dashboard" method="POST">
        ...
        <div class="sm:col-span-2 mb-4">
            ...
            <textarea id="body" name="body" rows="4" class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Write post body here"></textarea>
        </div>
