...
<div class="relative p-4 bg-white rounded-lg border dark:bg-gray-800 sm:p-5">
    ...
    <form action="/dashboard/{{ $post->slug }}" method="POST" id="post-form">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title" class="@error('title') border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 border @enderror 
            border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type post title name" autofocus value="{{ old('title') ?? $post->title }}">
            @error('title')
        ...
        <div class="mb-4">
            ...
            <select name="category_id" id="category" class="@error('category_id') border-red-500 text-red-700 placeholder-red-700 focus:ring-red-500 focus:border-red-500 border @enderror border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
